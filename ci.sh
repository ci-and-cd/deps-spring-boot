...
if [ -z "${CI_OPT_ORIGIN_REPO_SLUG}" ]; then if [ -n "${CI_PROJECT_PATH}" ]; then CI_OPT_ORIGIN_REPO_SLUG="ci-and-cd/deps-spring-boot"; else CI_OPT_ORIGIN_REPO_SLUG="ci-and-cd/deps-spring-boot"; fi; fi
